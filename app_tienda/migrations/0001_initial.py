# Generated by Django 4.1.2 on 2022-10-10 22:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proImagen', models.ImageField(blank=True, null=True, upload_to='producto/', verbose_name='foto para tu producto')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('idCategoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_tienda.categoria')),
            ],
        ),
        migrations.CreateModel(
            name='Foro',
